...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        "flex w-full items-center justify-between gap-2 rounded-xl border border-input bg-surface px-4 text-ink outline-none " +
          "transition-[color,box-shadow] focus-visible:border-brand focus-visible:ring-4 focus-visible:ring-ring/25 " +
      ...
      <SelectPrimitive.Content
        ...
        className={cn(
          "relative z-50 max-h-(--radix-select-content-available-height) min-w-32 overflow-y-auto overflow-x-hidden " +
            "rounded-xl border border-hairline bg-surface text-ink shadow-premium " +
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default select-none items-center gap-2 rounded-lg py-2.5 pl-3 pr-8 outline-none " +
